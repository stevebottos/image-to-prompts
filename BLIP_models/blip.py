...
class BLIP_Decoder(nn.Module):
    ...
    def _get_image_embeds(self, image, sample=False, num_beams=None):
        image_embeds = self.visual_encoder(image)

        if not sample and num_beams:
    ...
    def forward(self, image, caption):
        image_embeds, image_atts = self._get_image_embeds(image)
    ...
    def generate(
        ...
        image_embeds, image_atts = self._get_image_embeds(image, sample, num_beams)
